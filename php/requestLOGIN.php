...
if ($statement = $db->prepare("SELECT * FROM USER WHERE Username= ? AND Password = ? ")) {
    ...
    $statement->bind_result($UserID, $Username, $Password,$Sex,$prefer, $SessionID, $UsersessionID, $lobbyID);
